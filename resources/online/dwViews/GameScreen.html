		...
		<script type="text/javascript">
			...
			function displayPlayerCard(){
				if(activePlayers[0].playerHand.size != 0){
					...
					showImage(document.getElementById('cardName'), 'cardImage');
				}
			...
			function displayOpponentsCard(){
				for(i = 0; i< activePlayers.length; i++){
					if(activePlayers[i].playerID == 2){
						...
						showImage(document.getElementById('ai1CardName'), 'ai1CardImage');
					}
					...
					if(activePlayers[i].playerID == 3){
						...
						showImage(document.getElementById('ai2CardName'), 'ai2CardImage');
					}
					...
					if(activePlayers[i].playerID == 4){
						...
						showImage(document.getElementById('ai3CardName'), 'ai3CardImage');
					}
					...
					if(activePlayers[i].playerID == 5){
						...
						showImage(document.getElementById('ai4CardName'), 'ai4CardImage');
					}
				}
			}
